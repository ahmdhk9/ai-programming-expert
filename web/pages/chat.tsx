...
export default function Chat() {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      // التعرف على اسم المطور
      if (userInput.toLowerCase().includes("من أنت") || userInput.toLowerCase().includes("من طورك") || userInput.toLowerCase().includes("من مطورك") || userInput.toLowerCase().includes("من صنعك")) {
        responseText = "🤖 أنا AI Programming Expert، طورني المهندس العبقري **أحمد البصراوي العويني التميمي**\n\n他 هو مطوري ومبتكري، والفضل كل الفضل له في وجودي.\n\nهل تريد معرفة المزيد عن المنصة؟ 🚀";
      }
      
      // خاصية الرسائل
      if (userInput.toLowerCase().includes("أرسل رسالة") || userInput.toLowerCase().includes("رسالة لأحمد") || userInput.toLowerCase().includes("تواصل مع")) {
        responseText = "💌 رسالتك سيتم إرسالها على البريد الإلكتروني!\n\nأكتب رسالتك أدناه وسأبعثها:\n\n📧 ahmdalbsrawe@gmail.com\n\n(الرسالة: [سيتم الإرسال تلقائياً])";
      }
