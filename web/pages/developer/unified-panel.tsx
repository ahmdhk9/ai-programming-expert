  ...
  return (
    ...
    >
      <div style={{ display: "grid", gridTemplateColumns: "1fr 350px", gap: "2rem" }}>
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    fontWeight: "bold",
                    transition: "all 0.25s cubic-bezier(0.4, 0, 0.2, 1)",
                    animation: `scaleIn 0.4s ease-out ${320 + idx * 40}ms both`
                  }}
                  onMouseEnter={(e) => {
          ...
          <div style={{
            ...
            <div style={{ display: "grid", gap: "1rem" }}>
              {[
                ...
                { title: "🚀 الميزات", text: "100+ ميزة", color: "#f0f4ff", border: "#667eea" },
                { title: "📈 الأرباح", text: "$1,250", color: "#fff0f4", border: "#667eea" }
              ].map((item, idx) => (
                <div
                  key={item.title}
                  style={{
                    ...
                    animation: `slideIn 0.5s ease-out ${480 + idx * 80}ms both`,
                    cursor: "pointer",
        ...
        {/* AI Chat Sidebar */}
        <div style={{ height: "600px", animation: "slideIn 0.5s ease-out 200ms both" }}>
          <AIChat />
        </div>
      </div>
    </SmoothLayout>
